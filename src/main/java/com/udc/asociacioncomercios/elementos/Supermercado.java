...
public class Supermercado extends Comercio{
    ...
    public Supermercado(String nombre, String telefono, String email, String tipo, String barrio, String direccion) {
        super(nombre, telefono, email, tipo, barrio, direccion);
    }
